...
image_sepia_sse:
  ...
  add rsi, rdi           ; rsi = адрес первого байта после последнего пикселя
...
image_sepia_sse_loop_4_pixels:
  ...
  pmovzxbd xmm_ch2, xmm_ch2 ; (uint32[4]) g0 r0 b1 g1; с дополнением нулей
  shufps xmm_ch2, xmm_ch2, 0b11000000 ; перемешиваем
  cvtdq2ps xmm_ch2, xmm_ch2 ; конвертируем инт32 в флоат

  shr rdx, 8                ; (uint8[8]) r0 b1 g1 r1 b2 g2 00 00; сдвиг
  ...
  ; convert xmm_brgb [32] to int16[8]
